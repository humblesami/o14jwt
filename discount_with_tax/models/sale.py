...
class sale_order(models.Model):
    ...
    discount_amt = fields.Monetary(compute='_amount_all', string='- Discount', digits='Discount', store=True, copy=False)
    discount_type = fields.Selection([('line', 'Order Line'), ('global', 'Global')],string='Discount Applies to',default='global')
    discount_amt_line = fields.Float(compute='_amount_all', string='- Line Discount', digits='Line Discount', store=True, readonly=True, copy=False)
