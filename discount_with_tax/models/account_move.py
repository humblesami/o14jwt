...
class account_move(models.Model):
    ...
    def _compute_amount(self):
        ...
        sale_account_id = res_config.get_param('bi_sale_purchase_discount_with_tax.sale_account_id')
        purchase_account_id = res_config.get_param('bi_sale_purchase_discount_with_tax.purchase_account_id')
    ...
    def _recompute_tax_lines(self, recompute_tax_base_amount=False):
        ...
        def _compute_base_line_taxes(base_line):
            ...
            # Change quantity=quantity to quantity=1 in balance_taxes_res tuple
            ...
            print(333333333333333333333333333333333, balance_taxes_res)
