...
class OAuthProviderClient(models.Model):
    ...
    def _check_jwt_private_key(self):
        ...
        for client in self:
            ...
            if client.jwt_private_key and algorithm_prefix in self.CRYPTOSYSTEMS:
                ...
                if not isinstance(private_key, EllipticCurvePrivateKey) and not isinstance(private_key, RSAPrivateKey):
                    raise exceptions.ValidationError(_('The private key does not fit the selected algorithm!'))
    ...
    def generate_private_key(self):
        ...
        for client in self:
            ...
            if algorithm_prefix == 'ES':
                ...
                raise exceptions.UserError(_('You can only generate private keys for asymetric algorithms!'))
    ...
    def get_oauth2_server(self, validator=None, **kwargs):
        ...
        res = super().get_oauth2_server(validator=validator, **kwargs)
        return res
